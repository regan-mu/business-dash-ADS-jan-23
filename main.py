...
st.set_page_config(layout="wide", initial_sidebar_state="expanded", page_icon="⚡", page_title='Deja Vu Store Dashboard')
...
<p class="grey-text text-lighten-4">Jan 2023 Cohort</p>
</div>
